...
class ViewController: UIViewController , ColorTableViewControllerDelegate{
    ...
    @IBOutlet weak var colorValuesLabel: UILabel!
    ...
    func ColorTableViewChooseColor(controller: ColorTableViewController, chosenColor color: String){
        ...
        println("rgb tst: \(r)")
        colorValuesLabel.text = "RGB R: \(r), G: \(g), B: \(b)\nHSL H: \(hsl.H), S: \(hsl.S), L: \(hsl.L)\nHSV H: \(hsv.H), S: \(hsv.S), V: \(hsv.V)"
        
        if (historyLabel2.backgroundColor != nil){
            historyLabel3.backgroundColor = historyLabel2.backgroundColor
        }
        if (historyLabel1.backgroundColor != nil){
            historyLabel2.backgroundColor = historyLabel1.backgroundColor
        }
        
        historyLabel1.backgroundColor = labelColor
        ...
        println("choosecolor: \(labelColor)")
    }
